...
class XHProfRuns_Default implements iXHProfRuns
{
    ...
    public function getRunComparativeData($url, $c_url)
    {
        ...
        $row['95(`wt`)'] = $this->calculatePercentile(['count'  => $row['count(`id`)'],
                                                       'column' => 'wt',
                                                       'type'   => 'url',
                                                       'url'    => $url
        ]);
        $row['95(`cpu`)'] = $this->calculatePercentile(['count'  => $row['count(`id`)'],
                                                        'column' => 'cpu',
                                                        'type'   => 'url',
                                                        'url'    => $url
        ]);
        $row['95(`pmu`)'] = $this->calculatePercentile(['count'  => $row['count(`id`)'],
                                                        'column' => 'pmu',
                                                        'type'   => 'url',
                                                        'url'    => $url
        ]);
